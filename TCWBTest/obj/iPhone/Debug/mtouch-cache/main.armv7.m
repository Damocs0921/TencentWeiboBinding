...
extern void *mono_aot_module_TCWBTest_info;
extern void *mono_aot_module_monotouch_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_TXWBB_info;

void monotouch_register_modules ()
{
	mono_aot_register_module (mono_aot_module_TCWBTest_info);
	mono_aot_register_module (mono_aot_module_monotouch_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_TXWBB_info);
...
void monotouch_register_assemblies ()
{
	...
	monotouch_open_and_register ("TXWBB.dll");
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "TCWBTest.exe";
